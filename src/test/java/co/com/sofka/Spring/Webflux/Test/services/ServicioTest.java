package co.com.sofka.Spring.Webflux.Test.services;
...
class ServicioTest {
    ...
    void testVarios() {
        ...
        StepVerifier.create(uno).expectNext("Pedro").expectNext("Maria").expectNext("Jesus")
                .expectNext("Carmen").verifyComplete();
    }
    @Test
    ...
    {
        Flux<String> source = servicio.buscarTodosFiltroException();
